    ...
    const Stars = () => {
        ...
        return (
            <div className='absolute flex justify-center items-center w-full h-full'>
                {selectedNode && (
                    <div className="fixed top-10 left-10 right-10 bottom-10  dark:bg-slate-600 p-4 rounded-lg overflow-y-auto">
                        {/* Close button */}
                        <button 
                    ...
                    <div className="relative bg-white dark:bg-slate-500  rounded-lg shadow-lg p-4">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-end space-x-4 mt-4">
                                ...
                                <button onClick={handleDeleteLink} className="px-4 py-2 bg-amber-100 dark:bg-slate-500 border rounded-md hover:bg-amber-200 dark:hover:bg-slate-600">删除</button>
                            </div>
                        </div>
                    </div>
                </div>
